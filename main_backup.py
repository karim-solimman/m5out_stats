...
if __name__ == "__main__":
    ...
    parser.add_argument("--sim_cycles", help="Provide simulation clock cycles for simulation", default="5000000")
    ...
    data.append(args.synthetic) # append the type of the synthetic traffic that being used
